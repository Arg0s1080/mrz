...
__all__ = ["MRVACodeChecker", "code_list", "countries_list", "countries_code_list", "code_country_list",
           "is_country", "is_code", "get_code", "get_country", "find_country"]


class MRVACodeChecker(TD3CodeChecker):
    """
    Check the string code of the machine readable visas type A (MRVA)
    ...
    def __init__(self, mrz_code: str, check_expiry=False, compute_warnings=False):
        TD3CodeChecker.__init__(self, mrz_code, check_expiry, compute_warnings)
