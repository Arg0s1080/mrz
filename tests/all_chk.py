...
from tests.td1_chk_04 import TestCase21
...
class TestCaseChkAll(unittest.TestCase):
    def test_checker(self):
        ...
        TestCase15().test_td1_checker()    # fields()
        TestCase21().test_a_td1_checker()  # report warnings 1
        TestCase21().test_b_td1_checker()  # report warnings 2
